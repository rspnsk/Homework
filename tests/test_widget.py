...
test_data: List[Tuple[str, str]] = [
    ...
    ("MasterCard 1234567843буква", "Ошибка: Некорректный номер счета или карты"),
    ("MasterCard", "Ошибка: Некорректный номер счета или карты"),
    ("Счёт", "Ошибка: Некорректный номер счета или карты")
]
